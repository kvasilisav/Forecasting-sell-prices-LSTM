...
class DataProcessor:
    ...
    def _load_calendar(self):
        calendar = pd.read_csv(os.path.join(data_config.data_path, "calendar.csv"))
    ...
    def _load_sales_data(self):
        sales = pd.read_csv(
            os.path.join(data_config.data_path, "sales_train_validation.csv")
        )
        sales["item_store_id"] = sales["item_id"] + "_" + sales["store_id"]
        item_store_id = sales.iloc[data_config.item_index]["item_store_id"]
